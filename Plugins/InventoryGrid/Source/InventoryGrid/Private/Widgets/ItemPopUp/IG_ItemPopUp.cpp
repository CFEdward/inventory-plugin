...
void UIG_ItemPopUp::NativeOnInitialized()
{
...
void UIG_ItemPopUp::NativeOnMouseLeave(const FPointerEvent& InMouseEvent)
{
	Super::NativeOnMouseLeave(InMouseEvent);
	RemoveFromParent();
}

void UIG_ItemPopUp::SetSliderParams(const float Max, const float Value) const
{
...
void UIG_ItemPopUp::SplitButtonClicked()
{
...
int32 UIG_ItemPopUp::GetSplitAmount() const
{
	return FMath::Floor(Slider_Split->GetValue());
}

void UIG_ItemPopUp::CollapseSplitButton() const
{
...
void UIG_ItemPopUp::DropButtonClicked()
{
...
void UIG_ItemPopUp::ConsumeButtonClicked()
{
...
void UIG_ItemPopUp::CollapseConsumeButton() const
{
	Button_Consume->SetVisibility(ESlateVisibility::Collapsed);
}

void UIG_ItemPopUp::SliderValueChanged(const float Value)
{
	Text_SplitAmount->SetText(FText::AsNumber(FMath::Floor(Value)));
}

FVector2D UIG_ItemPopUp::GetBoxSize() const
{
